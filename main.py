...
imgElon_Musk = face_recognition.load_image_file('Images/Elon_Musk.jpg')
imgElon_Musk = cv2.cvtColor(imgElon_Musk,cv2.COLOR_BGR2RGB)
...
cv2.imshow('Elon Musk', imgElon_Musk)
